...
import { ArrowUpRight, Award, Brush, ChevronLeft, ChevronRight, Heart, MapPin, Sparkles, Users, X } from "lucide-react";
...
//#endregion
//#region src/assets/Extra_images/IMG_5686.JPG.jpeg
var IMG_5686_JPG_default = "/assets/IMG_5686.JPG-DuBXPa-T.jpeg";
//#endregion
//#region src/assets/Extra_images/IMG_5687.JPG.jpeg
var IMG_5687_JPG_default = "/assets/IMG_5687.JPG-DAXpkY7r.jpeg";
//#endregion
//#region src/assets/Extra_images/IMG_5688.JPG.jpeg
var IMG_5688_JPG_default = "/assets/IMG_5688.JPG-DF5Ifiis.jpeg";
//#endregion
//#region src/assets/Extra_images/IMG_5689.JPG.jpeg
var IMG_5689_JPG_default = "/assets/IMG_5689.JPG-krZWOZm5.jpeg";
//#endregion
//#region src/assets/Extra_images/IMG_5690.JPG.jpeg
var IMG_5690_JPG_default = "/assets/IMG_5690.JPG-kfcG1eq3.jpeg";
//#endregion
//#region src/assets/Extra_images/IMG_5691.JPG.jpeg
var IMG_5691_JPG_default = "/assets/IMG_5691.JPG-BvLzmuhp.jpeg";
//#endregion
//#region src/assets/Extra_images/IMG_5692.JPG.jpeg
var IMG_5692_JPG_default = "/assets/IMG_5692.JPG-CGqFjMRP.jpeg";
//#endregion
//#region src/assets/Extra_images/IMG_5693.JPG.jpeg
var IMG_5693_JPG_default = "/assets/IMG_5693.JPG-DlzryIZf.jpeg";
//#endregion
//#region src/assets/Extra_images/IMG_5694.JPG.jpeg
var IMG_5694_JPG_default = "/assets/IMG_5694.JPG-ZQhrFqnL.jpeg";
//#endregion
//#region src/assets/Extra_images/IMG_5695.JPG.jpeg
var IMG_5695_JPG_default = "/assets/IMG_5695.JPG-BLiuDuZ5.jpeg";
//#endregion
...
var paintProducts = [
	...
	{
		name: "Metallic Paint 1KG",
		unit: "Standard Unit",
		price: 2e4
	},
	{
		name: "Silk Premium Paint",
		unit: "Standard Bucket",
		price: 9e4
	},
	{
		name: "Weather Guard Paint",
		unit: "Standard Bucket",
		price: 1e5
	},
	{
	...
	{
		name: "Silver Paint (1L)",
		unit: "1 Liter",
		price: 25e3
	},
	{
		name: "NC Matt Cellulose",
		unit: "Standard Can",
		price: 3e4
	},
	{
...
var toolProducts = [
	...
	{
		name: "Udutimba (Mesh/Scrim Tape)",
		unit: "Pack / Roll",
		price: 5e3
	},
	{
		name: "Indasa Sandpaper (120 / 220 grit)",
		unit: "Roll / Pack",
		price: 1e3
	},
	{
		name: "Scotch Tape (Masking Tape)",
		unit: "Roll",
		price: 1e3
	},
	{
...
var catalogues = [
	{
		title: "Cool Greens",
		img: IMG_5686_JPG_default
	},
	{
		title: "Collection 02",
		img: IMG_5687_JPG_default
	},
	{
		title: "Collection 03",
		img: IMG_5688_JPG_default
	},
	{
		title: "Collection 04",
		img: IMG_5689_JPG_default
	},
	{
		title: "Collection 05",
		img: IMG_5690_JPG_default
	},
	{
		title: "Collection 06",
		img: IMG_5691_JPG_default
	},
	{
		title: "Collection 07",
		img: IMG_5692_JPG_default
	},
	{
		title: "Collection 08",
		img: IMG_5693_JPG_default
	},
	{
		title: "Collection 09",
		img: IMG_5694_JPG_default
	},
	{
		title: "Collection 10",
		img: IMG_5695_JPG_default
	}
];
var USD_RATE = 1450;
function fmtUSD(n) {
...
function Home() {
	...
	const [activeCategory, setActiveCategory] = useState("paints");
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", { children: [
								...
								/* @__PURE__ */ jsx("h2", {
									...
									children: "Products & Price List"
								}),
								/* @__PURE__ */ jsx("p", {
									className: "text-ink/60 mt-3 max-w-lg text-pretty",
									children: "Premium paints, finishes and application tools — priced transparently. Contact us for bulk or project-based rates."
								})
							] }), /* @__PURE__ */ jsxs("div", {
								className: "flex gap-2 self-start md:self-auto",
								children: [/* @__PURE__ */ jsx("button", {
									onClick: () => setActiveCategory("paints"),
									className: `px-5 py-3 text-xs font-semibold uppercase tracking-widest border transition-colors ${activeCategory === "paints" ? "bg-ink text-canvas border-ink" : "bg-transparent text-ink border-ink/20 hover:border-ink/40"}`,
									children: "Paints & Finishes"
								}), /* @__PURE__ */ jsx("button", {
									onClick: () => setActiveCategory("tools"),
									className: `px-5 py-3 text-xs font-semibold uppercase tracking-widest border transition-colors ${activeCategory === "tools" ? "bg-ink text-canvas border-ink" : "bg-transparent text-ink border-ink/20 hover:border-ink/40"}`,
									children: "Tools & Accessories"
								})]
							})]
						}),
						/* @__PURE__ */ jsxs("div", {
							className: "bg-canvas border border-ink/10",
							children: [/* @__PURE__ */ jsxs("div", {
								className: "hidden sm:grid grid-cols-12 gap-4 px-6 md:px-8 py-4 border-b border-ink/10 text-[10px] uppercase tracking-[0.25em] text-ink/50",
								children: [
									/* @__PURE__ */ jsx("span", {
							...
							}), (activeCategory === "paints" ? paintProducts : toolProducts).map((p, i) => /* @__PURE__ */ jsxs("div", {
								className: `grid grid-cols-12 gap-2 sm:gap-4 px-6 md:px-8 py-5 items-center ${i !== 0 ? "border-t border-ink/10" : ""} hover:bg-secondary/60 transition-colors`,
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("h4", {
											...
											className: "text-xs text-ink/50 mt-0.5 sm:hidden",
											children: p.unit
										})]
									}),
									/* @__PURE__ */ jsx("span", {
										className: "hidden sm:block col-span-3 text-sm text-ink/60",
										children: p.unit
									}),
									/* @__PURE__ */ jsx("span", {
										className: "col-span-4 sm:col-span-3 text-right text-sm font-medium text-brand whitespace-nowrap",
										children: p.price !== null ? `$${fmtUSD(p.price)}` : "On Request"
									})
								]
							}, p.name))]
						}),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("p", {
								className: "text-xs text-ink/50 text-pretty",
								children: "Prices listed in US Dollars (USD) and subject to change. Items marked \"On Request\" are quoted based on project scope."
							}), /* @__PURE__ */ jsxs(Link, {
								to: "/request-quote",
								...
								children: ["Request a Quote ", /* @__PURE__ */ jsx(ArrowUpRight, { size: 14 })]
							})]
						})
					]
				})
			...
			/* @__PURE__ */ jsxs("section", {
				className: "py-28 bg-secondary text-ink relative overflow-hidden",
				children: [/* @__PURE__ */ jsxs("div", {
					className: "max-w-7xl mx-auto px-6",
					children: [/* @__PURE__ */ jsx("div", {
						className: "flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16",
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("h2", {
									className: "font-display text-4xl md:text-5xl mt-4 font-medium text-balance",
									children: "Explore the Ubudasa Catalogue."
								}),
								/* @__PURE__ */ jsx("p", {
									className: "text-ink/60 mt-4 text-pretty",
									children: "Browse our full range of premium finishes, tones and textures — curated collections ready to bring your space to life."
								})
							]
						})
					}), /* @__PURE__ */ jsx("div", {
						className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-5",
						children: catalogues.map((c, i) => /* @__PURE__ */ jsxs("button", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-ink/80 via-ink/0 to-ink/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" }),
								/* @__PURE__ */ jsx("div", {
									className: "absolute bottom-0 left-0 right-0 p-4 translate-y-3 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300",
									children: /* @__PURE__ */ jsx("span", {
										className: "text-xs uppercase tracking-widest font-semibold text-canvas",
										children: c.title
									})
								}),
								/* @__PURE__ */ jsx("div", {
									className: "absolute top-3 right-3 w-8 h-8 rounded-full border border-ink/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity",
				...
				}), activeCatalogue !== null && /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("button", {
							onClick: (e) => {
								e.stopPropagation();
								setActiveCatalogue((activeCatalogue - 1 + catalogues.length) % catalogues.length);
							},
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("img", {
								...
								className: "text-canvas/70 text-xs uppercase tracking-[0.3em]",
								children: [
									catalogues[activeCatalogue].title,
									" — ",
									activeCatalogue + 1,
									" / ",
									catalogues.length
