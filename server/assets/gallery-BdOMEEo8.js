		...
		children: [
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: categories.map((c) => /* @__PURE__ */ jsx("button", {
							type: "button",
							onClick: () => setActive(c),
							className: `px-4 py-2 rounded-full text-xs uppercase tracking-widest border transition-colors ${active === c ? "bg-brand text-brand-foreground border-brand" : "bg-transparent text-ink border-black/15 hover:border-brand"}`,
							children: c
						}, c))
					})
				]
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: filtered.map((item, idx) => /* @__PURE__ */ jsxs("button", {
						type: "button",
