...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Rwanda's leading wall finishing, painting, and interior design studio. Premium craftsmanship for homes, hotels, and commercial spaces across Kigali." },
      { name: "author", content: "Ubudasa Wall Paints Ltd" },
